    ...
    def run_recognition(self):
        ...
        while True:
            ...
            if self.process_current_frame:
                ...
                # If there are no faces found, pause the video (Press the play/pause button on your keyboard)
                if self.face_locations == [] and self.is_video_active == True:
                            print('No faces found...')
                            keyboard = Controller()

                            # Press and release the play/pause button on your keyboard
            ...
            # Display the resulting image, if you dont want to see the video, comment this line
